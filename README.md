...
```
 git clone https://github.com/cestari15/exercicios-api.git
```
...
[![Run in Insomnia}](https://insomnia.rest/images/run.svg)](https://insomnia.rest/run/?label=Exerc%C3%ADcio%20API&uri=https%3A%2F%2Fraw.githubusercontent.com%2Fcestari15%2Fexercicios-api%2Fmain%2Fcomposer.json)
